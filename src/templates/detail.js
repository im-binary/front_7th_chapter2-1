import { CartIconButton, Header, PageLayout } from "../components/index.js";
...
const createDetailPage = ({ cartCount, body }) =>
  PageLayout({
    header: Header({
...
const detailLoadingContent = /*html*/ `
...
const detailLoadedContent = /*html*/ `
	<!-- 브레드크럼 -->
	<nav class="mb-4">
...
export const 상세페이지_로딩 = createDetailPage({
  cartCount: undefined,
  body: detailLoadingContent,
});

export const 상세페이지_로딩완료 = createDetailPage({
  cartCount: 1,
  body: detailLoadedContent,
});
